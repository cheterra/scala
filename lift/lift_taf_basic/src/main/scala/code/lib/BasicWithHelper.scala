...
object BasicWithHelper extends RestHelper {
   ...
   */
  serve {
    // Test 01.07.2011 Ho to get item by suffix xml
    case "simple3" :: "item" :: itemId :: "xml" :: Nil XmlGet _ =>
      for {
  ...
  serve {
    // Test 01.07.2011 Ho to get item by suffix xml
    case "simple4" :: "item" :: Item(item) :: "xml" :: Nil XmlGet _ =>
      item: Node

    // order changed, 01.07.2011 Ho
